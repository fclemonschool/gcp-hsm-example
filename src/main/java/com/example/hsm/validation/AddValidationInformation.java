...
package com.example.hsm.validation;

import com.example.hsm.cert.CRLVerifier;
import com.example.hsm.exception.CertificateVerificationException;
import com.example.hsm.cert.OcspHelper;
import com.example.hsm.exception.RevokedCertificateException;
import com.example.hsm.exception.CertificateProccessingException;
import com.example.hsm.util.SigUtils;
...
public class AddValidationInformation
{
    ...
    public static void main(String[] args) throws IOException, GeneralSecurityException
    {
        ...
        File inFile = new File("D:/doc/hello17.pdf");
